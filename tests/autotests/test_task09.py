...
try:
    from project.cfpq import hellings_based_cfpq, matrix_based_cfpq, tensor_based_cfpq
    from project.grammar_tools import cfg_to_rsm, ebnf_to_rsm
    from project.gll import gll_based_cfpq
except ImportError:
